...
const slice = createSlice({
  ...
  reducers: {
    setThemeDefault: (s, a: { payload: ThemeChoice }) => { s.theme = a.payload; },
    setServicesSort: (s, a: { payload: ServicesSort }) => { s.servicesSort = a.payload; },
    setServicesView: (s, a: { payload: ServicesView }) => { s.servicesView = a.payload; },
  },
});

export const { setThemeDefault, setServicesSort, setServicesView } = slice.actions;
