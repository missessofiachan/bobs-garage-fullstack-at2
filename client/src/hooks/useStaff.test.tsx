    ...
    get: vi.fn((url: string) => {
      if (url === '/staff') {
        return Promise.resolve({
          data: [
            { id: 1, name: 'John Doe', role: 'Mechanic', bio: 'Expert mechanic', photoUrl: '', active: true },
            { id: 2, name: 'Jane Smith', role: 'Manager', bio: 'Service manager', photoUrl: '', active: true },
          ],
        });
      }
      if (url === '/staff/1') {
        return Promise.resolve({
          data: { id: 1, name: 'John Doe', role: 'Mechanic', bio: 'Expert mechanic', photoUrl: '', active: true },
        });
      }
