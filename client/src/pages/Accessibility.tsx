							...
							<Card.Body className="p-4 p-md-5">
								...
								<div className="content" style={{ lineHeight: "1.8" }}>
									<section className="mb-4">
										...
										<p>
											Bob's Garage is committed to ensuring digital accessibility for people with disabilities.
											We are continually improving the user experience for everyone and applying the relevant
											accessibility standards to achieve WCAG 2.1 Level AA compliance.
										</p>
									</section>
									...
									<section className="mb-4">
										...
										<p>
											You can customize your experience by visiting the <a href="/settings">Settings page</a>{" "}
											where you can:
										</p>
										<ul>
									...
									<section className="mb-4">
										<h2>Feedback</h2>
										<p>
											We welcome your feedback on the accessibility of Bob's Garage. If you encounter
										...
										<p>
											We aim to respond to accessibility feedback within 5 business days and will provide a
											solution or update within 30 days when possible.
										</p>
									</section>
									...
									<section className="mb-4">
										...
										<p>
											This website strives to conform to Level AA of the World Wide Web Consortium (W3C) Web
											Content Accessibility Guidelines (WCAG) 2.1. These guidelines explain how to make web
									...
									<section className="mb-4">
										...
										<p>
											We are continuously working to improve the accessibility of our website. We regularly
											review our site and make updates to ensure we meet accessibility standards. If you notice
