							...
							<Card.Body className="p-4 p-md-5">
								...
								<div className="content" style={{ lineHeight: "1.8" }}>
									<section className="mb-4">
										...
										<p>
											By accessing or using Bob's Garage website and services, you agree to be bound by these
									...
									<section className="mb-4">
										<h2>Use License</h2>
										<p>
											Permission is granted to temporarily access the materials on Bob's Garage website for
									...
									<section className="mb-4">
										...
										<p>
											...
											complete, and current. You are responsible for safeguarding the password and for all
									...
									<section className="mb-4">
										...
										<p>
											In no event shall Bob's Garage or its suppliers be liable for any damages arising out of
