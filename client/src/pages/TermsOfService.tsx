							...
							<Card.Body className="p-4 p-md-5">
								...
								<div className="content" style={{ lineHeight: "1.8" }}>
									<section className="mb-4">
										...
										<p>
											By accessing or using Bob's Garage website and services, you agree to be bound
									...
									<section className="mb-4">
										<h2>Use License</h2>
										<p>
											Permission is granted to temporarily access the materials on Bob's Garage
									...
									<section className="mb-4">
										...
										<p>
											...
											accurate, complete, and current. You are responsible for safeguarding the
									...
									<section className="mb-4">
										...
										<p>
											We reserve the right to withdraw or amend our website and any service or
									...
									<section className="mb-4">
										...
										<p>
											In no event shall Bob's Garage or its suppliers be liable for any damages
											arising out of the use or inability to use the materials on our website, even
